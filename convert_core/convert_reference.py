...
def convert_abstract(old_session_maker, new_session_maker, chunk_size):
    ...
    log = logging.getLogger('convert.reference.abstract')
    log.info('begin')
    output_creator = OutputCreator(log)
...
def convert_bibentry(new_session_maker, chunk_size):
    ...
    log = logging.getLogger('convert.reference.bibentry')
    log.info('begin')
    output_creator = OutputCreator(log)
...
def convert_author(old_session_maker, new_session_maker, chunk_size):
    ...
    log = logging.getLogger('convert.reference.author')
    log.info('begin')
    output_creator = OutputCreator(log)
...
def convert_author_reference(old_session_maker, new_session_maker, chunk_size):
    ...
    log = logging.getLogger('convert.reference.author_reference')
    log.info('begin')
    output_creator = OutputCreator(log)
...
def convert_reftype(old_session_maker, new_session_maker):
    ...
    log = logging.getLogger('convert.reference.reftype')
    log.info('begin')
    output_creator = OutputCreator(log)
...
def convert_reference_relation(old_session_maker, new_session_maker):
    ...
    log = logging.getLogger('convert.reference.reference_relation')
    log.info('begin')
    output_creator = OutputCreator(log)
...
def convert_alias(old_session_maker, new_session_maker, chunk_size):
    ...
    log = logging.getLogger('convert.reference.reference_alias')
    log.info('begin')
    output_creator = OutputCreator(log)
