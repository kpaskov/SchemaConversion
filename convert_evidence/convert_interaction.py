...
def convert_physical_interevidence(old_session_maker, new_session_maker, chunk_size):
    ...
    log = logging.getLogger('convert.interaction.physical_interevidence')
    log.info('begin')
...
def convert_genetic_interevidence(old_session_maker, new_session_maker, chunk_size):
    ...
    log = logging.getLogger('convert.interaction.genetic_interevidence')
    log.info('begin')
    output_creator = OutputCreator(log)
...
def convert(old_session_maker, new_session_maker, ask=True):
    ...
    from model_new_schema.interaction import Physinteractionevidence, Geninteractionevidence
    ...
    convert_interaction(new_session_maker, Physinteractionevidence, 'PHYSINTERACTION', 'convert.interaction.physical_interaction', 10000, False)
    convert_interaction(new_session_maker, Geninteractionevidence, 'GENINTERACTION', 'convert.interaction.genetic_interaction', 10000, False)
